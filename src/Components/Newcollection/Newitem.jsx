...
import "../Newcollection/Newitems.css";
import Footer from "../Footerpart/Footer";
import { Link } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { fetchNewCollection } from "../../toolkit/slice";
...
const Newitem = () => {
  ...
  return (
    <section className="container newitem-page">
      <section className="top-part">
        <div className="pt-3 d-flex justify-content-between">
          <ArrowBackIosNewIcon />
          <span className="fw-bold">New Items</span>
